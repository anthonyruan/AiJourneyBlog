          ...
          {isAdmin && (
            <div className="mb-4 space-y-2">
              <button 
                ...
                className="inline-flex items-center justify-center w-full px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-md font-medium text-sm"
              >
              ...
              <button 
                ...
                className="inline-flex items-center justify-center w-full px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md font-medium text-sm"
              >
